...
const createResume = async (req, res) => {
  ...
  Can you write a 100 words description for the top of the resume(first person writing)? and dont add \n`;
  ...
  make sure to include the span and dont add tag at the start and dont add \n`;
